...
if (typeof(AppSettings).Assembly.GetName().Version?.ToString(3) != "1.1.1")
    throw new InvalidOperationException("La versione dell'assembly non corrisponde alla release 1.1.1.");
