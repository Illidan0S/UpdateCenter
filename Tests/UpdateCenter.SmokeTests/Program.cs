...
if (typeof(AppSettings).Assembly.GetName().Version?.ToString(3) != "1.1.0")
    throw new InvalidOperationException("La versione dell'assembly non corrisponde alla preview 1.1.0.");
